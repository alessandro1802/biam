    ...
    pub fn determine_initial_temperature(&mut self) {
        ...
        for i in 0..sample_n {
            ...
            for j in i + 2..self.n {
                ...
                if delta < 0.0 {
                    average_delta += delta as f64;
                }
                n_samples += 1;
            }
        }
        average_delta /= n_samples as f64;
        
        // Set acceptance probability to 98/100;
        self.T = -100.0 * average_delta / 98.0;
    }
        ...
        while current_T > 1.0 {
            ...
            for i in 0..self.n {
                ...
                for j in i + 2..self.n {
                    ...
                    if delta < 0.0 || -delta as f64 / current_T > rand::random() {
