...
def mutate_mod(self, genotype_list: List[str]) -> List[str]:
	"""
    Returns:
	...
	def modify(var):
		return max(var._value() - 1 / (max(self.counter / 75, 1) + 100) * var._value(), 0)

	frams.GenMan.f0_p_new = modify(frams.GenMan.f0_p_new)
	frams.GenMan.f0_p_del = modify(frams.GenMan.f0_p_del)
	frams.GenMan.f0_p_swp = modify(frams.GenMan.f0_p_swp)
	frams.GenMan.f0_p_pos = modify(frams.GenMan.f0_p_pos)
	frams.GenMan.f0_p_den = modify(frams.GenMan.f0_p_den)
	frams.GenMan.f0_p_frc = modify(frams.GenMan.f0_p_frc)
	frams.GenMan.f0_p_ing = modify(frams.GenMan.f0_p_ing)
	frams.GenMan.f0_p_asm = modify(frams.GenMan.f0_p_asm)
	frams.GenMan.f0_p_color = modify(frams.GenMan.f0_p_color)
...
def main():
	...
	framsLib.counter = 0
	framsLib.mutate = mutate_mod.__get__(framsLib, FramsticksLib)
